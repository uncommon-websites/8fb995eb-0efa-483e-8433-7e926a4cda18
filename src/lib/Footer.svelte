  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
      ...
      <div class="col-span-1 lg:col-span-1">
        <a href="/" class="flex items-center gap-2 mb-6">
           <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-orange-brand">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
          ...
          <span class="font-bold text-xl tracking-tight">Kudobox</span>
        </a>
      </div>

      <!-- Product -->
      <div>
        <h4 class="font-bold mb-4 text-gray-400 uppercase text-xs tracking-wider">Product</h4>
        <ul class="space-y-3">
          ...
          <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Slack Integration</a></li>
      ...
      <!-- Company -->
      <div>
        <h4 class="font-bold mb-4 text-gray-400 uppercase text-xs tracking-wider">Company</h4>
        <ul class="space-y-3">
      ...
      <div class="lg:col-span-1">
        <div class="bg-orange-brand rounded-2xl p-6 text-dark relative overflow-hidden">
             <h3 class="font-serif text-2xl mb-4 leading-tight">Start Recognizing Your Team</h3>
             <ul class="space-y-2 mb-6 text-sm font-medium">
                <li class="flex items-start gap-2">
                    <svg class="w-4 h-4 mt-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M20 6L9 17l-5-5" stroke-linecap="round" stroke-linejoin="round"/></svg>
             ...
             <div class="flex flex-col gap-2">
                 <button class="bg-dark text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-800 transition-colors w-full text-center">Start Free Trial &rarr;</button>
                 <button class="bg-white text-dark px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-100 transition-colors w-full text-center">See Demo</button>
             </div>
        </div>
      </div>
    </div>
    ...
    <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
      <div class="text-gray-500 text-sm">
        Kudobox turns gratitude into action through shareable digital thank-you cards that strengthen team connections.
      </div>
      <div class="flex items-center gap-6">
         ...
         <span class="text-gray-600 text-xs">© 2024 MigRun. All rights reserved.</span>
